...
Todas las modificaciones notables a las skills y la documentación se registran aquí.

El formato sigue [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) y este proyecto usa [Semantic Versioning](https://semver.org/spec/v2.0.0.html) aplicado al contenido (cambios mayores en reglas = bump mayor).

## [0.1.0] — Fase 1 (release inicial)
